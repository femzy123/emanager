defmodule EventmanagerWeb.EventControllerTest do
  ...
  @create_attrs %{date: ~D[2010-04-17], description: "some description", location: "some location", name: "some name", status: "some status"}
  ...
  def fixture(:event) do
    {:ok, event} = Manager.create_event(@create_attrs)
    event
  end
